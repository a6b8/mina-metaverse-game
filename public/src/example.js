        ...
        body.shapes.forEach( function( shape ) {
            ...
            switch( shape.type ) {
                ...
                case CANNON.Shape.types.PLANE:
                    ...
                    var floorMap = THREE.ImageUtils
                        .loadTexture( "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMaznkwKbnlWTf0zzL9uQrUQ2Q54MfyI7JC5m62icHR5oRjT1v" );
...
.then( function ( data ) {
    ...
    terrainBody.position.set( 
        -sizeX * terrainShape.elementSize / 2, 
        -10, 
...
//flag light
var pointflagLight = new THREE.PointLight( new THREE.Color( 'orange' ), 1.5, 5 );
...
const imageSrc = textureLoader
.load('https://raw.githubusercontent.com/baronwatts/models/master/snowflake.png');
...
( function animate() {
    ...
    //display coordinates
    info.innerHTML = `
<span>X: </span>${mesh.position.x.toFixed(2)}, &nbsp;&nbsp;&nbsp; <span>Y: </span>${mesh.position.y.toFixed(2)}, &nbsp;&nbsp;&nbsp; <span>Z: </span>${mesh.position.z.toFixed(2)}
`
